...
# if not video specified, then reading from webcam
if args.get("video", None) is None:
	camera = cv2.VideoCapture(0)
	time.sleep(0.25)

#otherwise, reading from a video file
else:
...
while True:
	...
	thresh = cv2.threshold(frame_delta, 150, 255, cv2.THRESH_BINARY)[1]
